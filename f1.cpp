...
void introScreen()
{
    ...
    glColor3f(1.0, 0.0, 0.0);
    displayRasterText(-425, 490, 0.0, "INDIAN INSTITUTE OF INFORMATION TECHNOLOGY PUNE");
    glColor3f(1.0, 1.0, 1.0);
    displayRasterText(-210, 385, 0.0, "COMPUTER GRAPHICS");
    glColor3f(0.0, 0.0, 1.0);
    displayRasterText(-180, 300, 0.0, "FINAL LAB PROJECT ");
    ...
    glColor3f(1.0, 1.0, 1.0);
    displayRasterText(-800, -200, 0.0, " Aakarsh Srivastawa");
    displayRasterText(-800, -285, 0.0, " Abhikrant Dhepe");
    displayRasterText(-800, -375, 0.0, " Abhilash Bora");
    glColor3f(1.0, 0.0, 0.0);
    displayRasterText(500, -100, 0.0, "Under the Guidance of");
    glColor3f(1.0, 1.0, 1.0);
    displayRasterText(500, -200, 0.0, "Prof Amruta Lipare");
    glColor3f(1.0, 0.0, 0.0);
    displayRasterText(-250, -400, 0.0, "Academic Year 2024");
    glColor3f(1.0, 1.0, 1.0);
